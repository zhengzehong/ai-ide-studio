...
- [x] **Step 1: Write command contract and validation RED tests**
...
- [x] **Step 3: Implement the closed command union**
...
- [x] **Step 4: Write Writer-ledger RED tests**
...
- [x] **Step 6: Implement migration and Writer operations**
...
- [x] **Step 7: Write shared service/dispatcher RED tests**
...
- [x] **Step 10: Write HTTP route/client RED tests**
...
- [x] **Step 12: Implement HTTP route and browser migration**
...
- [x] **Step 13: Verify Task 1 and commit**
...
- [x] **Step 1: Write storage adapter RED tests**
...
- [x] **Step 4: Write snapshot coordinator RED tests**
...
- [x] **Step 5: Run coordinator RED**

Run: `npx vitest run tests/unit/bootstrap-snapshot.test.ts`

Expected: FAIL because the coordinator does not exist.

- [x] **Step 6: Implement bounded export/hydration**
...
- [x] **Step 7: Reconcile lifecycle and deletion**
...
- [x] **Step 1: Write route/cache RED tests**
...
- [x] **Step 3: Implement lazy route registry and cache middleware**
...
- [x] **Step 4: Add bundle budget gate**
...
- [x] **Step 1: Write event-loop monitor RED tests**
...
- [x] **Step 4: Write process-failure RED tests**
...
- [x] **Step 5: Run process-failure RED**
...
- [x] **Step 6: Implement the soak and browser runners**
...
- [x] **Step 7: Run final performance gates**
...
- [x] **Step 8: Update stable documentation**
...
- [x] **Step 10: Request review and report Phase 5**
