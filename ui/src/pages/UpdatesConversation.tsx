    ...
    <main className="wb-conversation">
      ...
      <div className="wb-message-scroll" ref={scrollRef}>
        ...
        {isStreaming && streamingMessage && (
          <div data-bubble style={{ display: 'flex', gap: 10, alignItems: 'flex-start', margin: '0 auto', maxWidth: 900, padding: '0 20px', boxSizing: 'border-box' }}>
...
function ConversationMessage({ message, agentColor, agentName }: { message: MessageData; agentColor: string; agentName?: string | null }) {
  ...
  return (
    <div data-bubble style={{ display: 'flex', gap: 10, alignItems: 'flex-start', flexDirection: isHuman ? 'row-reverse' : 'row', margin: '0 auto', maxWidth: 900, padding: '0 20px', boxSizing: 'border-box' }}>
