 ...
 */
export function TeamSessionActions({ pinned, canMarkUnread, pendingAction, onTogglePin, onMarkUnread }: TeamSessionActionsProps) {
  return (
    <>
      <button
        type="button"
        ...
        style={pendingAction !== null ? disabledStyle : undefined}
      >
