...
register(secretaryListHandler)
register(secretaryGetHandler)
register(secretaryCreateHandler)
register(secretaryUpdateHandler)
register(secretaryDeleteHandler)
